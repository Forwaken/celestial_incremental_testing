...
let VERSION = {
	num: 11500, // CHANGED TO NUMBER TO MAKE EASIER IN FUTURE (EX. 11403 = v1.14.3)
	name: "Tera",
}
...
function updateStyles() {
	...
	switch(player.tab) {
		...
		case "tera":
			...
			break;
		case "sins":
			layerBG = "linear-gradient(0deg, #0e140e)"
			break;
		case "hte":
			layerBG = "linear-gradient(0deg, #100a04)"
			break;
		case "bigc":
		...
		case "tad":
			...
			if (player.subtabs["tad"]["Tabs"] == "Perks") layerBG = "linear-gradient(0deg, #98d6d7)"
			break;
		case "ca":
...
let changelog = `<h1>Changelog:</h1><br>
	...
	<h3>v1.15 - The Novasent Update Part IV: Tera [UNFINISHED]</h3><br>
		Content:<br>
		...
		Minor Changes:<br>
			...
			- Added a bulk-assign button to Vex.<br>
		...
		Balancing:<br>
			...
			- Reduced Stagnant Synestia's max combo from 100 -> 50.<br>
			- Doubled the scaling of stagnant synestia's combo formula.<br>
			...
			- Added softcaps to charger milestones.<br>
			- Made the check back ritual cooldown be affected by check back tickspeed.<br>
			- Nerfed the "3 of Diamonds" card.<br><br>
		Bug Fixes:<br>
			...
			- Fixed the spelling of "Remembrance" in many parts of the game.<br>
...
var doNotCallTheseFunctionsEveryTick = [
	...
	"slotReset", "enhanceReset", "teraReset", "effects", "cardReset", "cardDraw", "startGame", "endGame", "resetCreation",
	"diamondDustReset",
	"openChest",
	"checkAchs",
...
function fixOldSave(oldVersion){
	...
	if (oldVersion < 11500 && player.stagnantSynestia) {
		if (player.d && player.d.boosterEffects) {
			...
			player.d.boosterEffects[11] = player.d.boosterEffects[11].log(10).min(1e5)
		}
