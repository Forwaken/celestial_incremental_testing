    ...
    microtabs: {
        stuff: {
            "Main": {
                ...
                content: [
                    ["raw-html", () => { return "Repli-Grass mult: x" + formatSimple(player.rg.repliGrassMult, 2) + "." }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                    ["raw-html", () => { return "Repli-Grass mult cap: x" + formatSimple(player.rg.repliGrassMult.mul(player.rg.repliGrassCap), 2) + "." }, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
