addLayer("in", {
    ...
    update(delta) {
        ...
        player.in.infinitiesToGet = player.in.infinitiesToGet.mul(buyableEffect("tad", 211))
        ...
        if (player.in.pylonBuilt)
        {
            ...
            if (player.sins.clickables["envy"] || player.tera.sinMastery[0]) player.in.pylonEnergyPerSecond = player.in.pylonEnergyPerSecond.mul(player.sins.envy[2])
    ...
    infoboxes: {
        ...
        3: {
            ...
            body() { return "Otherworldly Features were created by a group of celestials called the Novasent. So far, I have only discovered three of them: Dice, Rocket Fuel, and " + player.h.stageName[0] + ". The superphysical values that are a part of OTFs are artificial. I find dice to be the most intriguing. The entropic value of these OTFs are fascinating. Randomness isn't too common within SPVs, and especially not artificial SPVs. Zar, the celestial that created this OTF, is a very mysterious celestial. I've heard that he is the strongest of all the novasent. Rocket fuel is also very powerful, as it can lead into multiple universes. It was created by Iridite, the Astral Celestial. I've spoken with her once. She is an insanely smart celestial, but she seems to have psychopathic tendencies. Apparently Iridite and Zar don't get along very well... " + player.h.stageName[0] + " is the last of the main three OTFs.  This SPV is extremely rare, as instead of representing one number, it is a list of numbers. This one was created by Tera, the Celestial of Tiers. Tera is the most mysterious of the three novasent. I don't have any information on this celestial... Apparently there is an entire universe dedicated to " + player.h.stageName[1] + ". How strange is that??" },
