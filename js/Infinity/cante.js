addLayer("ca", {
    ...
    buyables: {
        11: {
            ...
            effect(x) { return getBuyableAmount(this.layer, this.id).min(75).mul(0.005) },
            unlocked: true,
        ...
        stuff: {
            "Unlock": {
                ...
                content: [
                    ...
                    ["raw-html", function () { return format(player.h.hexPoint) + "/1e36 " + player.h.stageName[0] + " Points" }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
