...
BHP.vespasian = {
    ...
    regen() {return new Decimal(0.3).mul(player.bh.baseMult)},
...
BHP.diceFive = {
    name() {return player.zarDungeon.zarDefeated ? "<small>Dice Five's Husk</small>" : "Dice Five"},
    color: "#a3a3a3", 
    ...
    damage() {return hasUpgrade("zd", 15) ? new Decimal(5).mul(player.bh.baseMult) : new Decimal(3).mul(player.bh.baseMult)},
