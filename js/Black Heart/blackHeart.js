                    ...
                    ["row", [
                            ...
                            ["row", [
                                ["style-column", [
                                    ...
                                    ["style-row", [
                                        ...
                                        ["tooltip-row", [["raw-html", () => {return player.bh.characters[0].attributes.haze ? "⚯<div class='bottomTooltip' style='margin-top:0px'>Haze<hr>Incoming actions have a<br>" + formatSimple(Decimal.mul(player.bh.characters[0].attributes.haze, 100)) + "% chance to miss.</div>" : ""}, {color: "#C4BDC9", fontSize: "30px", fontFamily: "monospace", textShadow: "1px 1px 1px black, -1px 1px 1px black, -1px -1px 1px black, 1px -1px 1px black"}]]],
                                ...
                                ["style-column", [
                                    ...
                                    ["style-row", [
                                        ...
                                        ["tooltip-row", [["raw-html", () => {return player.bh.characters[1].attributes.haze ? "⚯<div class='bottomTooltip' style='margin-top:0px'>Haze<hr>Incoming actions have a<br>" + formatSimple(Decimal.mul(player.bh.characters[1].attributes.haze, 100)) + "% chance to miss.</div>" : ""}, {color: "#C4BDC9", fontSize: "30px", fontFamily: "monospace", textShadow: "1px 1px 1px black, -1px 1px 1px black, -1px -1px 1px black, 1px -1px 1px black"}]]],
                                    ], {width: "150px", height: "30px", marginTop: "-35px"}],
                                ], {margin: "5px"}],
                            ]],
                            ["style-column", [
                                ...
                                ["style-row", [
                                    ...
                                    ["tooltip-row", [["raw-html", () => {return player.bh.characters[2].attributes.haze ? "⚯<div class='bottomTooltip' style='margin-top:0px'>Haze<hr>Incoming actions have a<br>" + formatSimple(Decimal.mul(player.bh.characters[2].attributes.haze, 100)) + "% chance to miss.</div>" : ""}, {color: "#C4BDC9", fontSize: "30px", fontFamily: "monospace", textShadow: "1px 1px 1px black, -1px 1px 1px black, -1px -1px 1px black, 1px -1px 1px black"}]]],
                                ], {width: "150px", height: "30px", marginTop: "-35px"}],
                            ], {margin: "5px"}],
                        ]],
                        ["blank", ["50px", "50px"]],
                        ["style-column", [
                            ...
                            ["style-row", [
                                ...
                                ["tooltip-row", [["raw-html", () => {return player.bh.celestialite.attributes.haze ? "⚯<div class='bottomTooltip' style='margin-top:0px'>Haze<hr>Incoming actions have a<br>" + formatSimple(Decimal.mul(player.bh.celestialite.attributes.haze, 100)) + "% chance to miss.</div>" : ""}, {color: "#C4BDC9", fontSize: "30px", fontFamily: "monospace", textShadow: "1px 1px 1px black, -1px 1px 1px black, -1px -1px 1px black, 1px -1px 1px black"}]]],
                            ], {width: "150px", height: "30px", marginTop: "-35px"}],
                            ["style-column", [
                                ["blank", "20px"],
                                ["row", [
