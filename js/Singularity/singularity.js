addLayer("s", {
    ...
    milestones: {
        ...
        20: {
            ...
            effectDescription() {return "Keep IP related blessing boosters, NIP related jinxes, and graces on all resets.<br>Deposit 6% of boons per second. Keep any " + player.h.stageName[1] + " Qol control values."},
