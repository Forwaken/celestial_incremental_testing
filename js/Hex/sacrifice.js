addLayer("hsa", {
    ...
    upgrades: {
        11: {
            title: "Simplicity",
            unlocked: true,
            description() {return "Double " + player.h.stageName[1] + " point gain after softcap."},
            cost: new Decimal(1),
        ...
        13: {
            title: "Coherence",
            unlocked: true,
            description() {return "Sacred energy boosts " + player.h.stageName[1] + " point gain after softcap."},
            cost: new Decimal(8),
            currencyLocation() { return player.hsa },
            currencyDisplayName: "Sacred Energy",
            currencyInternalName: "sacredEnergy",
        ...
        21: {
            ...
            description() {return "Total power above 360,000 boosts " + player.h.stageName[1] + " point gain after softcap."},
        ...
        2: {
            ...
            display() {
                return "<h3>Intelligence</h3>\n\
                    ...
                    Double " + player.h.stageName[1] + " points after softcap.\n\
                    Currently: " + formatWhole(tmp[this.layer].buyables[this.id].effect) + "x\n\ \n\
                    Cost: " + formatWhole(tmp[this.layer].buyables[this.id].cost) + " Sacred Energy"
            },
            buy(mult) {
    ...
    tabFormat: [
        ...
        ["row", [
            ["raw-html", () => {return "Adds +" + format(player.hsa.sacredEffect, 3) + " to the " + player.h.stageName[1] + " point softcap exponent." }, {color: "rgba(0,0,0,0.6)", fontSize: "16px", fontFamily: "monospace"}],
