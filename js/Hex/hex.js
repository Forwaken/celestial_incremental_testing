...
addLayer("h", {
    ...
    update(delta) {
        ...
        if (player.tera.chronotachysisSpell[0].gt(0)) player.h.tickspeed = player.h.tickspeed.mul(buyableEffect("tera", "chronotachysisBuff")).mul(Decimal.pow(3, player.tera.chronotachysisSpell[1]))
