addLayer("sins", {
    ...
    update (delta) {
        ...
        if (hasUpgrade("hpw", 2003)) player.sins.wrath[0] = Decimal.pow(Decimal.div(4.9, player.h.stage).add(1), player.hcu.curses.add(1).log(666).pow(0.7))
        else player.sins.wrath[0] = Decimal.pow(Decimal.div(4.2, player.h.stage).add(1), player.hcu.curses.add(1).log(666).pow(0.7))
