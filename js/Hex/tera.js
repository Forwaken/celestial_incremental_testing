...
addNode("chronotachysisSpell", {
    name() {return "<h2>⏳</h2>"},
    symbol() {return "⏳"},
    tooltip() {return "<h3>Chronotachysis</h3><br>Increases uni-alpha tickspeed by x" + formatSimple(buyableEffect("tera", "chronotachysisBuff").mul(Decimal.pow(3, player.tera.spellEnhancement))) + " for " + formatTime(Decimal.add(60, buyableEffect("tera", "chronotachysisDuration").sub(1))) + "<br>Currently: x" + formatSimple(buyableEffect("tera", "chronotachysisBuff").mul(Decimal.pow(3, player.tera.chronotachysisSpell[1]))) + " for " + formatTime(player.tera.chronotachysisSpell[0]) + "<br><br>" + formatSimple(player.tera.hexEnergy) + "/" + formatSimple(Decimal.div(10, buyableEffect("tera", "chronotachysisCost")).mul(Decimal.pow10(player.tera.spellEnhancement))) + " Hex-Energy"},
    ...
    onClick() {
        if (this.canClick()) {
            ...
            duration = duration.mul(Decimal.pow10(player.tera.chronotachysisSpell[1].sub(player.tera.spellEnhancement)))
...
addLayer("tera", {
    ...
    startData() { return {
        ...
        virtueEffects: [
            [new Decimal(1), new Decimal(1), new Decimal(1)], [new Decimal(1), new Decimal(1), new Decimal(0)],
        ...
        virtueUnlocks2: [false, false, false, false, false, false, false],
    ...
    update (delta) {
        ...
        if (hasAchievement("achievements", 1404)) player.tera.hexEnergyGain = player.tera.hexEnergyGain.mul(1.7)
        ...
        player.tera.virtueReq[0] = layers.h.hexReq(player.tera.virtue[0], 1, 1.7, new Decimal(1)).floor()
        player.tera.virtueGain[0] = layers.h.hexGain(player.tera.heptEssence, 1, 1.7, new Decimal(1)).sub(player.tera.virtue[0]).max(0).ceil()
        ...
        player.tera.virtueEffects[0][2] = player.tera.virtueEssence[0].gte(1e7) ? Decimal.pow(1.1, player.tera.virtueEssence[0].div(1e7).add(1).log(7).pow(0.7)) : new Decimal(1)
        if (!player.tera.virtueUnlocks[0] && player.tera.virtueEssence[0].gte(3500)) player.tera.virtueUnlocks[0] = true
        if (!player.tera.virtueUnlocks2[0] && player.tera.virtueEssence[0].gte(1e12)) player.tera.virtueUnlocks2[0] = true
        if (player.tera.trueHept.gte(2)) player.tera.virtue[0] = player.tera.virtue[0].add(player.tera.virtueGain[0])
        player.tera.virtueReq[1] = layers.h.hexReq(player.tera.virtue[1], 7, 1.5, new Decimal(1)).floor()
        player.tera.virtueGain[1] = layers.h.hexGain(player.tera.virtue[0], 7, 1.5, new Decimal(1)).sub(player.tera.virtue[1]).max(0).ceil()
        ...
        player.tera.virtueEffects[1][2] = player.tera.virtueEssence[1].gte(1e8) ? player.tera.virtueEssence[1].div(1e8).add(1).log(7).add(1).floor() : new Decimal(0)
        if (!player.tera.virtueUnlocks[1] && player.tera.virtueEssence[1].gte(14000)) player.tera.virtueUnlocks[1] = true
        if (!player.tera.virtueUnlocks2[1] && player.tera.virtueEssence[1].gte(1e14)) player.tera.virtueUnlocks2[1] = true
        if (player.tera.trueHept.gte(4)) player.tera.virtue[1] = player.tera.virtue[1].add(player.tera.virtueGain[1])
        player.tera.virtueReq[2] = layers.h.hexReq(player.tera.virtue[2], 14, 1.45, new Decimal(1)).floor()
        player.tera.virtueGain[2] = layers.h.hexGain(player.tera.virtue[1], 14, 1.45, new Decimal(1)).sub(player.tera.virtue[2]).max(0).ceil()
        ...
        player.tera.virtueEffects[2][2] = player.tera.virtueEssence[2].gte(1e9) ? Decimal.pow(3, player.tera.virtueEssence[2].div(1e9).add(1).log(7).pow(0.7)) : new Decimal(1)
        if (!player.tera.virtueUnlocks[2] && player.tera.virtueEssence[2].gte(70000)) player.tera.virtueUnlocks[2] = true
        if (!player.tera.virtueUnlocks2[2] && player.tera.virtueEssence[2].gte(1e16)) player.tera.virtueUnlocks2[2] = true
        if (player.tera.trueHept.gte(6)) player.tera.virtue[2] = player.tera.virtue[2].add(player.tera.virtueGain[2])
        player.tera.virtueReq[3] = layers.h.hexReq(player.tera.virtue[3], 21, 1.4, new Decimal(1)).floor()
        player.tera.virtueGain[3] = layers.h.hexGain(player.tera.virtue[2], 21, 1.4, new Decimal(1)).sub(player.tera.virtue[3]).max(0).ceil()
        ...
        player.tera.virtueEffects[3][2] = player.tera.virtueEssence[3].gte(1e10) ? Decimal.pow(2, player.tera.virtueEssence[3].div(1e10).add(1).log(7).pow(0.5)) : new Decimal(1)
        if (!player.tera.virtueUnlocks[3] && player.tera.virtueEssence[3].gte(350000)) player.tera.virtueUnlocks[3] = true
        if (!player.tera.virtueUnlocks2[3] && player.tera.virtueEssence[3].gte(1e18)) player.tera.virtueUnlocks2[3] = true
        player.tera.virtueReq[4] = layers.h.hexReq(player.tera.virtue[4], 28, 1.35, new Decimal(1)).floor()
        player.tera.virtueGain[4] = layers.h.hexGain(player.tera.virtue[3], 28, 1.35, new Decimal(1)).sub(player.tera.virtue[4]).max(0).ceil()
        ...
        player.tera.virtueEffects[4][2] = player.tera.virtueEssence[4].gte(1e11) ? Decimal.pow(1.5, player.tera.virtueEssence[4].div(1e11).add(1).log(7).pow(0.7)) : new Decimal(1)
        if (!player.tera.virtueUnlocks[4] && player.tera.virtueEssence[4].gte(1.4e6)) player.tera.virtueUnlocks[4] = true
        if (!player.tera.virtueUnlocks2[4] && player.tera.virtueEssence[4].gte(1e19)) player.tera.virtueUnlocks2[4] = true
        ...
        player.tera.virtueEffects[5][2] = player.tera.virtueEssence[5].gte(1e12) ? Decimal.pow(2, player.tera.virtueEssence[5].div(1e12).add(1).log(7).pow(0.7)) : new Decimal(1)
        if (!player.tera.virtueUnlocks[5] && player.tera.virtueEssence[5].gte(7e6)) player.tera.virtueUnlocks[5] = true
        if (!player.tera.virtueUnlocks2[5] && player.tera.virtueEssence[5].gte(1e20)) player.tera.virtueUnlocks2[5] = true
        ...
        player.tera.virtueEffects[6][2] = player.tera.virtueEssence[6].gte(1e14) ? player.tera.virtueEssence[6].div(1e14).add(1).log(7).pow(0.7).div(100).add(1) : new Decimal(1)
        if (!player.tera.virtueUnlocks[6] && player.tera.virtueEssence[6].gte(3.5e7)) player.tera.virtueUnlocks[6] = true
        if (!player.tera.virtueUnlocks2[6] && player.tera.virtueEssence[6].gte(1e24)) player.tera.virtueUnlocks2[6] = true
    ...
    clickables: {
        ...
        "chronotachysisSpell": {
            title() {return "<h3>Chronotachysis</h3><br>Increases uni-alpha tickspeed by x" + formatSimple(buyableEffect("tera", "chronotachysisBuff").mul(Decimal.pow(3, player.tera.spellEnhancement))) + " for " + formatTime(Decimal.add(60, buyableEffect("tera", "chronotachysisDuration").sub(1))) + "<br>Currently: x" + formatSimple(buyableEffect("tera", "chronotachysisBuff").mul(Decimal.pow(3, player.tera.chronotachysisSpell[1]))) + " for " + formatTime(player.tera.chronotachysisSpell[0]) + "<br><br>" + formatSimple(Decimal.div(10, buyableEffect("tera", "chronotachysisCost")).mul(Decimal.pow10(player.tera.spellEnhancement))) + " Hex-Energy"},
            canClick() {return player.tera.hexEnergy.gte(Decimal.div(10, buyableEffect("tera", "chronotachysisCost")).mul(Decimal.pow10(player.tera.spellEnhancement)))},
            unlocked: true,
            onClick() {
                player.tera.hexEnergy = player.tera.hexEnergy.sub(Decimal.div(10, buyableEffect("tera", "chronotachysisCost")).mul(Decimal.pow10(player.tera.spellEnhancement)))
    ...
    buyables: {
        ...
        "hexEnergyPrestige": {
            ...
            style() {
                let look = {width: "305px", height: "110px", fontSize: "12px", lineHeight: "1", color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "0", padding: "10px"}
                getBuyableAmount(this.layer, this.id).gte(this.purchaseLimit()) ? look.background = "#77bf5f" : !this.canAfford() ? look.background =  "#bf8f8f" : look.background = "#ffbf00"
                return look
            },
        },
    ...
    upgrades: {
        ...
        "hept4": {
            fullDisplay() {return "<h3>Crystalized Tiers</h3><br>Remove crystal effect's hardcap<br><br>Cost: 140 η-Provenance<br><small>[REQ BEING IN HEPT]</small>"},
            unlocked() {return player.tera.unsealed && player.tera.trueHept.gte(1)},
            canAfford() { return player.h.stage.eq(7) && player.hpr.rank[6].gte(140)},
            pay() {player.hpr.rank[6] = player.hpr.rank[6].sub(140)},
            style() {
                let look = {width: "140px", color: "rgba(0,0,0,0.8)", border: "3px solid rgba(0,0,0,0.5)", borderRadius: "15px", margin: "2px"}
                hasUpgrade(this.layer, this.id) ? look.background = "#77bf5f" : !canAffordUpgrade(this.layer, this.id) ? look.background =  "#bf8f8f" : look.background = "#85ADE6"
                return look
        ...
        "hept10": {
            fullDisplay() {return "<h3>Negative Jinxed</h3><br>Massively improve Μ-Jinx effect<br><br>Cost: 1e14 Hept Essence"},
            unlocked() {return player.tera.unsealed && player.tera.trueHept.gte(1)},
                ...
                content: [
                    ...
                    ["style-row", [
                        ["style-column", [
                            ...
                            ["raw-html", "Improves the power of spells", {color: "white", fontSize: "14px", fontFamily: "monospace"}],
                ...
                content: [
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e7", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Provenance Effects: x" + formatSimple(player.tera.virtueEffects[0][2], 2)}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[0].lt(1e7)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [
                                ...
                                ["style-row", [["raw-html", () => {return "Unlock a new DU1 upgrade"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[0] && player.tera.virtueEssence[0].lt(1e12)) {look.background = "#bf8f8f"};return look}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e8", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Jinx Cap: +" + formatWhole(player.tera.virtueEffects[1][2])}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[1].lt(1e8)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [
                                ["style-row", [["raw-html", "1e14", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Automate jinxed jinx"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[1] && player.tera.virtueEssence[1].lt(1e14)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e9", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Boons: x" + formatSimple(player.tera.virtueEffects[2][2], 2)}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[2].lt(1e9)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [ // Blessing Booster Bulk Gain
                                ["style-row", [["raw-html", "1e16", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                            ...
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[2] && player.tera.virtueEssence[2].lt(1e16)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e10", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Temperers: x" + formatSimple(player.tera.virtueEffects[3][2], 2)}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[3].lt(1e10)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [
                                ["style-row", [["raw-html", "1e18", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Remove universe limits on available refinement milestones"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", lineHeight: "0.75", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[3] && player.tera.virtueEssence[3].lt(1e18)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e11", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "Pre-power Resources x" + formatSimple(player.tera.virtueEffects[4][2], 2) }, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[4].lt(1e11)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [
                                ["style-row", [["raw-html", "1e19", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "[NOT IMPLEMENTED]"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[4] && player.tera.virtueEssence[4].lt(1e19)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ...
                                ["style-row", [["raw-html", () => {return "Unlock a new pet evolution"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[5] && player.tera.virtueEssence[5].lt(1e20)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
                    ...
                    ["style-row", [
                        ...
                        ["top-column", [
                            ...
                            ["style-row", [
                                ["style-row", [["raw-html", "1e14", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "External Effects: ^" + formatSimple(player.tera.virtueEffects[6][2], 3)}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (player.tera.virtueEssence[6].lt(1e14)) {look.background = "#bf8f8f"};return look}],
                            ["style-row", [ // Unlock for a new dark OTF (idk which one to pick, there are so many)
                                ["style-row", [["raw-html", "1e24", {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "100px", height: "27px", borderRight: "3px solid rgba(0,0,0,0.5)"}],
                                ["style-row", [["raw-html", () => {return "[NOT IMPLEMENTED]"}, {color: "rgba(0,0,0,0.7)", fontSize: "14px", fontFamily: "monospace"}]], {width: "289px", height: "27px"}],
                            ], () => {let look = {width: "392px", height: "27px", background: "#77bf5f", border: "3px solid rgba(0,0,0,0.5)", marginTop: "-3px"};if (!player.tera.virtueUnlocks2[6] && player.tera.virtueEssence[6].lt(1e24)) {look.background = "#bf8f8f"};return look}],
                        ], {width: "398px", height: "194px", borderLeft: "3px solid #95A6DD", userSelect: "none"}],
