﻿addLayer("du", {
    ...
    update(delta) {
        ...
        if (player.du.pointSoftcap.gt(1.79e308)) player.du.pointSoftcap = player.du.pointSoftcap.div(1.79e308).pow(player.du.pointSoftcap.add(1).log(1.79e308)).mul(1.79e308)
        if (getLevelableTier("pu", 201, true)) player.du.pointSoftcap = player.du.pointSoftcap.pow(levelableEffect("pu", 201)[0])
