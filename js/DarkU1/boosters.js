addLayer("db", {
    ...
    update(delta) {
        ...
        if (getLevelableTier("pu", 216, true)) player.db.boosterReqDivisor = player.db.boosterReqDivisor.mul(levelableEffect("pu", 216)[0])
    ...
    layerShown() {
        return hasUpgrade("le", 101) || player.dotf.penumbral ? true : 'ghost' 
    },
